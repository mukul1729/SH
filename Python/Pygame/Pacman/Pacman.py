...
pacman_right = pygame.image.load(
    '/run/media/mukul/D/Programming/SH/Python/Pygame/Pacman/pacman/pacman_right.gif')
pacman_left = pygame.image.load(
    '/run/media/mukul/D/Programming/SH/Python/Pygame/Pacman/pacman/pacman_left.gif')
pacman_up = pygame.image.load(
    '/run/media/mukul/D/Programming/SH/Python/Pygame/Pacman/pacman/pacman_up.gif')
pacman_down = pygame.image.load(
    '/run/media/mukul/D/Programming/SH/Python/Pygame/Pacman/pacman/pacman_down.gif')
background = pygame.image.load(
    '/run/media/mukul/D/Programming/SH/Python/Pygame/Pacman/pacman/dot.gif')
wall = pygame.image.load(
    '/run/media/mukul/D/Programming/SH/Python/Pygame/Pacman/pacman/wall.gif')
monster = pygame.image.load(
    '/run/media/mukul/D/Programming/SH/Python/Pygame/Pacman/pacman/monster1.gif')
