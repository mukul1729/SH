...
badd +1 ~/Desktop/file.sh
badd +51 term://~/Documents/SH//26231:/bin/bash
badd +132 Latex/resume/latex_cv-master/CV.tex
badd +7 term://~/Documents/SH//15230:/bin/bash
badd +65 Latex/resume/latex_cv-master/muratcan_cv.cls
badd +1 Python/Test/new.py
badd +1 Python/Projects/snake.py
badd +1 web_dev/HTML/test.html
badd +1 Python/Projects/paint/paint.py
...
badd +1 Python/Test/codeforces.py
badd +1 OCaml/hello.ml
badd +1 term://~/Documents/SH//31649:/bin/bash
badd +1 Python/Test/code.py
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Documents/SH//31649:/bin/bash", ":p")) | buffer term://~/Documents/SH//31649:/bin/bash | else | edit term://~/Documents/SH//31649:/bin/bash | endif
if &buftype ==# 'terminal'
...
silent! normal! zE
let &fdl = &fdl
let s:l = 55 - ((26 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 55
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Documents/SH//2455:/bin/bash", ":p")) | buffer term://~/Documents/SH//2455:/bin/bash | else | edit term://~/Documents/SH//2455:/bin/bash | endif
if &buftype ==# 'terminal'
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Documents/SH//2576:/bin/bash", ":p")) | buffer term://~/Documents/SH//2576:/bin/bash | else | edit term://~/Documents/SH//2576:/bin/bash | endif
if &buftype ==# 'terminal'
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Documents/SH//6610:/bin/bash", ":p")) | buffer term://~/Documents/SH//6610:/bin/bash | else | edit term://~/Documents/SH//6610:/bin/bash | endif
if &buftype ==# 'terminal'
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Documents/SH//5017:/bin/bash", ":p")) | buffer term://~/Documents/SH//5017:/bin/bash | else | edit term://~/Documents/SH//5017:/bin/bash | endif
if &buftype ==# 'terminal'
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Documents/SH//6131:/bin/bash", ":p")) | buffer term://~/Documents/SH//6131:/bin/bash | else | edit term://~/Documents/SH//6131:/bin/bash | endif
if &buftype ==# 'terminal'
...
wincmd w
argglobal
if bufexists(fnamemodify("term://~/Documents/SH//31262:/bin/bash", ":p")) | buffer term://~/Documents/SH//31262:/bin/bash | else | edit term://~/Documents/SH//31262:/bin/bash | endif
if &buftype ==# 'terminal'
